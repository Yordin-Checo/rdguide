...
class Comofunciona extends StatefulWidget {
  @override
  _Comofunciona createState() => new _Comofunciona();
}

class _Comofunciona extends State<Comofunciona> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Como funciona', style: TextStyle(color: Colors.black),textAlign: TextAlign.center,),
        elevation: 0,
        leading: IconButton(
