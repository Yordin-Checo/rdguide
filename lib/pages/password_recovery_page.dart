            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 6,),
                  Text("Llegara un mensaje a tu correo de restablecimiento de contraseña.",style: TextStyle(fontSize: 20,color: Colors.grey.shade400),),
                ],
              ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text("Ya poseo una cuenta.",style: TextStyle(fontWeight: FontWeight.bold),),
                    GestureDetector(
                      onTap: (){
